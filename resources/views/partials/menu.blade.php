<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('crane_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/producers*") ? "c-show" : "" }} {{ request()->is("admin/types*") ? "c-show" : "" }} {{ request()->is("admin/cranes*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @can('service_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/maintenances*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
