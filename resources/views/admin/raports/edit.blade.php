...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.raport.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.raports.update", [$raport->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crane_sn') ? 'is-invalid' : '' }}" name="crane_sn_id" id="crane_sn_id" required>
                    @foreach($crane_sns as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crane_sn_id') ? old('crane_sn_id') : $raport->crane_sn->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data') ? 'is-invalid' : '' }}" type="text" name="data" id="data" value="{{ old('data', $raport->data) }}">
                @if($errors->has('data'))
                    <div class="invalid-feedback">
                        {{ $errors->first('data') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $raport->start) }}">
                @if($errors->has('start'))
                    <div class="invalid-feedback">
                        {{ $errors->first('start') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('stop') ? 'is-invalid' : '' }}" type="text" name="stop" id="stop" value="{{ old('stop', $raport->stop) }}">
                @if($errors->has('stop'))
                    <div class="invalid-feedback">
                        {{ $errors->first('stop') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('work') ? 'is-invalid' : '' }}" type="text" name="work" id="work" value="{{ old('work', $raport->work) }}">
                @if($errors->has('work'))
                    <div class="invalid-feedback">
                        {{ $errors->first('work') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine') ? 'is-invalid' : '' }}" type="text" name="engine" id="engine" value="{{ old('engine', $raport->engine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_kraj') ? 'is-invalid' : '' }}" type="text" name="gps_kraj" id="gps_kraj" value="{{ old('gps_kraj', $raport->gps_kraj) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_woj') ? 'is-invalid' : '' }}" type="text" name="gps_woj" id="gps_woj" value="{{ old('gps_woj', $raport->gps_woj) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_city') ? 'is-invalid' : '' }}" type="text" name="gps_city" id="gps_city" value="{{ old('gps_city', $raport->gps_city) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_ulica') ? 'is-invalid' : '' }}" type="text" name="gps_ulica" id="gps_ulica" value="{{ old('gps_ulica', $raport->gps_ulica) }}">
