    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nip') ? 'is-invalid' : '' }}" type="text" name="nip" id="nip" value="{{ old('nip', 'PL951-20-32-166') }}">
                @if($errors->has('nip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('regon') ? 'is-invalid' : '' }}" type="text" name="regon" id="regon" value="{{ old('regon', '') }}">
                @if($errors->has('regon'))
                    <div class="invalid-feedback">
                        {{ $errors->first('regon') }}
                    </div>
