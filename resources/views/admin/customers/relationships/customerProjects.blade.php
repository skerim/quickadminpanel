...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-customerProjects">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.project.fields.email_contact') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-customerProjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
