    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rentals.update", [$rental->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id" required>
                    @foreach($projects as $id => $entry)
                        <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $rental->project->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crane') ? 'is-invalid' : '' }}" name="crane_id" id="crane_id">
                    @foreach($cranes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crane_id') ? old('crane_id') : $rental->crane->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('crane'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rental_start') ? 'is-invalid' : '' }}" type="text" name="rental_start" id="rental_start" value="{{ old('rental_start', $rental->rental_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rental_end') ? 'is-invalid' : '' }}" type="text" name="rental_end" id="rental_end" value="{{ old('rental_end', $rental->rental_end) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hp') ? 'is-invalid' : '' }}" type="number" name="hp" id="hp" value="{{ old('hp', $rental->hp) }}" step="1">
                @if($errors->has('hp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lw') ? 'is-invalid' : '' }}" type="number" name="lw" id="lw" value="{{ old('lw', $rental->lw) }}" step="1">
                @if($errors->has('lw'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lw') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lifting_capacity') ? 'is-invalid' : '' }}" type="number" name="lifting_capacity" id="lifting_capacity" value="{{ old('lifting_capacity', $rental->lifting_capacity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('power') ? 'is-invalid' : '' }}" type="number" name="power" id="power" value="{{ old('power', $rental->power) }}" step="1">
                @if($errors->has('power'))
                    <div class="invalid-feedback">
                        {{ $errors->first('power') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anchor') ? 'is-invalid' : '' }}" type="text" name="anchor" id="anchor" value="{{ old('anchor', $rental->anchor) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cross') ? 'is-invalid' : '' }}" type="text" name="cross" id="cross" value="{{ old('cross', $rental->cross) }}">
                @if($errors->has('cross'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cross') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('foundation_level') ? 'is-invalid' : '' }}" type="number" name="foundation_level" id="foundation_level" value="{{ old('foundation_level', $rental->foundation_level) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_crane') ? 'is-invalid' : '' }}" type="text" name="name_crane" id="name_crane" value="{{ old('name_crane', $rental->name_crane) }}">
