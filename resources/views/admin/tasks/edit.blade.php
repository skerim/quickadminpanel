    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crane_type') ? 'is-invalid' : '' }}" name="crane_type_id" id="crane_type_id" required>
                    @foreach($crane_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crane_type_id') ? old('crane_type_id') : $task->crane_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crane') ? 'is-invalid' : '' }}" name="crane_id" id="crane_id">
                    @foreach($cranes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crane_id') ? old('crane_id') : $task->crane->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('crane'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end') ? 'is-invalid' : '' }}" type="text" name="end" id="end" value="{{ old('end', $task->end) }}">
                @if($errors->has('end'))
                    <div class="invalid-feedback">
                        {{ $errors->first('end') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $task->start) }}">
                @if($errors->has('start'))
                    <div class="invalid-feedback">
                        {{ $errors->first('start') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hp') ? 'is-invalid' : '' }}" type="text" name="hp" id="hp" value="{{ old('hp', $task->hp) }}">
                @if($errors->has('hp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lw_jb') ? 'is-invalid' : '' }}" type="text" name="lw_jb" id="lw_jb" value="{{ old('lw_jb', $task->lw_jb) }}">
                @if($errors->has('lw_jb'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lw_jb') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('kontrahent') ? 'is-invalid' : '' }}" name="kontrahent_id" id="kontrahent_id">
                    @foreach($kontrahents as $id => $entry)
                        <option value="{{ $id }}" {{ (old('kontrahent_id') ? old('kontrahent_id') : $task->kontrahent->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $task->location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monters') ? 'is-invalid' : '' }}" type="text" name="monters" id="monters" value="{{ old('monters', $task->monters) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hydr') ? 'is-invalid' : '' }}" type="text" name="hydr" id="hydr" value="{{ old('hydr', $task->hydr) }}">
                @if($errors->has('hydr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hydr') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comments') ? 'is-invalid' : '' }}" type="text" name="comments" id="comments" value="{{ old('comments', $task->comments) }}">
