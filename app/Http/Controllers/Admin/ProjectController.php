...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $projects = Project::with(['customers', 'users', 'rentals', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.projects.create', compact('customers', 'users', 'rentals'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        $project->load('customers', 'users', 'rentals');

        return view('admin.projects.edit', compact('customers', 'users', 'rentals', 'project'));
    }
    ...
    public function show(Project $project)
    {
        ...
        $project->load('customers', 'users', 'rentals', 'projectRentals');
