...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $projects = Project::with(['users', 'customers', 'rentals', 'media'])->get();
    ...
    public function create()
    {
        ...
        $rentals = Rental::all()->pluck('name_crane', 'id');

        return view('admin.projects.create', compact('users', 'customers', 'rentals'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        $project->load('users', 'customers', 'rentals');

        return view('admin.projects.edit', compact('users', 'customers', 'rentals', 'project'));
    }
    ...
    public function show(Project $project)
    {
        ...
        $project->load('users', 'customers', 'rentals', 'projectRentals', 'craneRentals');
