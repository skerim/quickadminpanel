...
class MaintenanceApiController extends Controller
{
    public function index()
    {
        ...
        return new MaintenanceResource(Maintenance::with(['crane', 'project', 'conservator'])->get());
    }
    ...
    public function show(Maintenance $maintenance)
    {
        ...
        return new MaintenanceResource($maintenance->load(['crane', 'project', 'conservator']));
    }
